...
function ConvenioMedico() {
    ...
    const actionButtonTemplate = (rowData) => {
        return (
            <React.Fragment>
                <SplitButton icon="pi pi-bars" model={actionsButton(rowData)} className="border-round" />
            </React.Fragment>
        );
    };
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <React.Fragment>
                <Button icon="pi pi-pencil" className="border-round p-button-rounded p-button-primary" onClick={() => editConvenio(rowData)} />
            ...
            <Dialog header={header} modal={false} visible={convenioVisible} style={{ width: '80vw', height: '80vh' }} onHide={() => setConvenioVisible(false)}>
                ...
                <div className="card">
                    <DataTable ref={dt} value={convenios} selection={selectedConvenios} onSelectionChange={e => setSelectedConvenios(e.value)}
                        ...
                        <Column body={actionButtonTemplate}></Column>
