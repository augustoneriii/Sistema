...
namespace app.DAO
{
    public class ProfissionaisDAO
    {
        ...
        public async Task<int> Insert(ProfissionaisDTO dto)
        {
            ...
            objInsert.Append($" {dto.Profissoes.Id},                     ");
            objInsert.Append($" {dto.ConvenioMedicos[0].Id},             ");
        ...
        public async Task<int> Update(ProfissionaisDTO dto)
        {
            ...
            objUpdate.Append($" \"ProfissaoId\" = {dto.Profissoes.Id}, ");
            objUpdate.Append($" \"ConvenioId\" = {dto.ConvenioMedicos[0].Id}, ");
